          ...
          <div className="glass-card rounded-3xl p-6 border border-slate-800 sticky top-28 flex flex-col max-h-[82vh] justify-between shadow-2xl">
            <div>
              ...
              <div className="overflow-y-auto max-h-[35vh] pr-1 space-y-3 mb-4 scrollbar-thin">
                {cart.map((item) => (
                  <div key={item.dishId} className="flex items-center justify-between bg-slate-950 p-3 rounded-xl border border-slate-850">
            ...
            <div className="border-t border-slate-850 pt-4 space-y-4">
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between text-slate-100 font-bold text-sm border-t border-slate-850 pt-3">
                  <span>Total Due</span>
